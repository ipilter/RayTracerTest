  ...
  , mRayTracer( std::make_unique<rt::RayTracer>() )
{
  ...
  wxButton* saveBtn( new wxButton( btnPanel, wxID_ANY, "Save" ) );
  ...
  saveBtn->Bind( wxEVT_COMMAND_BUTTON_CLICKED, &MainFrame::OnSaveButton, this );
  ...
  btnSizer->Add( saveBtn, 0, wxEXPAND );
